        ...
        Route::middleware(['auth:backoffice'])->group(function () {
            ...
            Route::prefix('agencies')
                ...
                ->group(function () {
                    ...
                    // ==================== AGENCY SETTINGS ====================
                    Route::get('/{agency}/profile', [AgencyController::class, 'profile'])
                        ->name('profile')
                        ->middleware('role:super-admin,backoffice');
                    Route::get('/{agency}/settings', [AgencySettingsController::class, 'edit'])
                        ->name('settings.edit')
                        ->middleware('role:super-admin,backoffice');
                    Route::get('/{agency}/settings/notifications', [AgencySettingsController::class, 'notifications'])
                        ->name('settings.notifications')
                        ->middleware('role:super-admin,backoffice');
                    Route::get('/{agency}/settings/invoice-template', [AgencySettingsController::class, 'invoiceTemplate'])
                        ->name('settings.invoice-template')
                        ->middleware('role:super-admin,backoffice');
                    Route::get('/{agency}/settings/company', [AgencySettingsController::class, 'company'])
                        ->name('settings.company')
                        ->middleware('role:super-admin,backoffice');
                    Route::get('/{agency}/settings/signatures', [AgencySettingsController::class, 'signatures'])
            ...
            Route::prefix('vehicles')
                ...
                ->group(function () {
                     ...
                     * ==================== VEHICLE VIGNETTES ====================
                     */
                    // GLOBAL VIGNETTES ROUTES
                    Route::prefix('vignettes')
                        ->name('vignettes.')
                        ->group(function () {
                    ...
                    // VEHICLE-SPECIFIC VIGNETTES ROUTES
                     ...
                     * ==================== VEHICLE INSURANCES ====================
                     */
                    // GLOBAL INSURANCES ROUTES
                    Route::prefix('insurances')
                        ->name('insurances.')
                        ->group(function () {
                    ...
                    // VEHICLE-SPECIFIC INSURANCES ROUTES
                     ...
                     * ==================== VEHICLE OIL CHANGES ====================
                     */
                    // GLOBAL OIL CHANGES ROUTES
                    Route::prefix('oil-changes')
                        ->name('oil-changes.')
                        ->group(function () {
                    ...
                    // VEHICLE-SPECIFIC OIL CHANGES ROUTES
                     ...
                     */
                    // GLOBAL TECHNICAL CHECKS ROUTES
                    Route::prefix('technical-checks')
                    ...
                    // VEHICLE-SPECIFIC TECHNICAL CHECKS ROUTES
                    ...
                    // VEHICLE-SPECIFIC CONTROLS ROUTES
