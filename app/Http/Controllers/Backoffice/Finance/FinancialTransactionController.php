...
class FinancialTransactionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backoffice.finance.transactions.create', compact('accounts', 'categories'));
    }
    ...
    public function edit(FinancialTransaction $financialTransaction)
    {
        ...
        return view('backoffice.finance.transactions.edit', compact('financialTransaction', 'accounts', 'categories'));
    }
