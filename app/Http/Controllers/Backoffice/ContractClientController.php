...
public function index(Request $request)
{
    ...
    $query = ContractClient::with(['rentalContract', 'client'])
        ->whereHas('rentalContract', function($q) use ($agencyId) {
            ...
            // Remove the ->whereNull('deleted_at') or let it be handled by the model
        });

    // Remove the global scope for soft deletes if it's causing issues
    ...
    public function create()
    {
        ...
        return view('backoffice.contract-clients.create', compact('contracts', 'clients', 'nextOrder'));
    }
    ...
    public function edit(ContractClient $contractClient)
    {
        ...
        return view('backoffice.contract-clients.edit', compact('contractClient', 'contracts', 'clients'));
    }
...
public function destroy(ContractClient $contractClient)
{
    try {
        ...
        // REMOVE THIS CHECK if you want to allow deleting primary clients
        // if ($contractClient->role === 'primary') {
        //     return redirect()->back()->with('toast', [
        //         'title' => 'Erreur',
        //         'message' => 'Impossible de supprimer le client principal.',
        //         'dot' => '#dc3545',
        //         'delay' => 3500,
        //         'time' => 'now',
        //     ]);
