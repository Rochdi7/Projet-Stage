...
class PaymentController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('backoffice.payments.create', compact('accounts', 'invoices', 'contracts', 'selectedInvoice'));
    }
    ...
    public function edit(Payment $payment)
    {
        ...
        return view('backoffice.payments.edit', compact('payment', 'accounts', 'invoices', 'contracts'));
    }
