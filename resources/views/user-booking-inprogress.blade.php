        ...
        <div class="container">
            ...
            <div class="content-header d-flex align-items-center justify-content-between">
                ...
                <ul class="booking-nav">
                    <li>
                        <a href="{{url('user-booking-inprogress')}}" class="active"><i class="fa-solid fa-list"></i></a>
                    </li>
                    <li>
                        <a href="{{url('booking-inprogress-calendar')}}"><i class="fa-solid fa-calendar-days"></i></a>
                    </li>
                </ul>
            </div>
            <!-- /Content Header -->
