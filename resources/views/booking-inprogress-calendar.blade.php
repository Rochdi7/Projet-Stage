<?php $page = 'booking-inprogress-calendar'; ?>
        ...
        <div class="container">
            ...
            <div class="content-header d-flex align-items-center justify-content-between">
                ...
                <ul class="booking-nav">
                    <li>
                        <a href="{{ url('user-booking-inprogress') }}"><i class="fa-solid fa-list"></i></a>
                    </li>
                    <li>
                        <a href="{{ url('booking-inprogress-calendar') }}" class="active"><i
            ...
            <div class="row">
                ...
                <div class="col-lg-12 ">
                    <div class="card calendar-card mb-0">
                        <div class="card-body">
                            <div id="inprogress-calendar"></div>
                        </div>
                    </div>
                </div>
                <!-- /Inprogress -->
