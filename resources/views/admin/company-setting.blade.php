        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <div class="card">
                    ...
                    <form action="{{url('admin/company-setting')}}">
                        <div class="card-body">
                            <div class="localization-content mb-3">
                                <div>
                                    <h6 class="mb-3">Company Settings</h6>
                                    <div class="mb-3">
                                        <p class="fw-medium mb-0 text-gray-9 mb-1">Profile Photo</p>
                                        <div class="d-flex align-items-center flex-wrap row-gap-3  mb-3">                                                
                                            <div class="d-flex align-items-center justify-content-center avatar avatar-xxl  me-3 flex-shrink-0 text-dark frames">
                                                <img src="{{URL::asset('admin_assets/img/settings/company-logo-01.jpg')}}" class="rounded-circle" alt="img">
                                                <span class="avatar-badge avatar-badge-end bg-white p-1"><i class="ti ti-trash text-danger fs-12"></i></span>
                                            </div>                                              
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="select">
                                                ...
                                                <option>Peer-to-Peer Car Renta</option>
                                                <option>Electric and Hybrid Vehicles</option>
                            ...
                            <div class="mb-0">
                                ...
                                <p class="mb-2">As the current owner of this workspace, you must select an existing admin to transfer ownership.</p>
                                <div class="row">  
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-end justify-content-between">
                                            <div class="w-100 me-3">
                                                ...
                                                <select class="select">
                                                    <option>Select</option>
                                                    <option>Adrian Saurez  </option>
                                                    <option>Jessica David</option>
                                                    <option>Hendrita Margerate</option>
                                                    <option>Silvaa Andrew</option>
                                                </select>
                                            </div>
                                            <a href="javascript:void(0);" class="btn btn-primary mb-1">Update</a>
                                        </div>
                                    </div>
                                    <div>
                                </div>
