                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-tabs-bottom tab-dark mb-3">
                            <li class="nav-item"><a class="nav-link active" href="#bottom-tabs1"
                                    data-bs-toggle="tab">Home</a></li>
                            <li class="nav-item"><a class="nav-link" href="#bottom-tabs2"
                                    data-bs-toggle="tab">Profile</a></li>
                            <li class="nav-item"><a class="nav-link" href="#bottom-tabs3"
                                    data-bs-toggle="tab">Messages</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="bottom-tabs2">
                                Tab content 2
                            </div>
                            <div class="tab-pane" id="bottom-tabs3">
                                Tab content 3
                            </div>
                        </div>
                    </div>
