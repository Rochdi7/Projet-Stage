		...
		<div class="content me-4">
			...
			<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
				...
				<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
					...
					<div class="mb-2">
						<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_inspection" class="btn btn-primary d-flex align-items-center"><i class="ti ti-plus me-2"></i>Add New Inspection</a>
					</div>
				</div>
			</div>
			<!-- /Breadcrumb -->
					...
					<div class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-lg p-2">
							<ul>
								...
								<li>
									<div class="dropdown-item d-flex align-items-center justify-content-between rounded-1">
										<span><i class="ti ti-grip-vertical me-1"></i>INSPECTED STATUS</span>
										<div class="form-check form-check-sm form-switch mb-0">
											<input class="form-check-input form-label" type="checkbox" role="switch" checked="">
										</div>
									</div>
								...
								<li>
									<div class="dropdown-item d-flex align-items-center justify-content-between rounded-1">
										<span><i class="ti ti-grip-vertical me-1"></i>INSPECTION DATE</span>
										<div class="form-check form-check-sm form-switch mb-0">
											<input class="form-check-input form-label" type="checkbox" role="switch" checked="">
										</div>
									</div>
								...
								<li>
									<div class="dropdown-item d-flex align-items-center justify-content-between rounded-1">
										<span><i class="ti ti-grip-vertical me-1"></i>INSPECTED BY</span>
										<div class="form-check form-check-sm form-switch mb-0">
											<input class="form-check-input form-label" type="checkbox" role="switch" checked="">
										</div>
									</div>
								...
								<li>
									<div class="dropdown-item d-flex align-items-center justify-content-between rounded-1">
										<span><i class="ti ti-grip-vertical me-1"></i>REPAIR STATUS</span>
										<div class="form-check form-check-sm form-switch mb-0">
											<input class="form-check-input form-label" type="checkbox" role="switch" checked="">
										</div>
									</div>
				...
				<div class="filterbox mb-3 d-flex align-items-center">
					...
					<div class="dropdown me-2">
						...
						<ul class="dropdown-menu dropdown-menu-lg p-3">
							...
							<li>
								<label class="dropdown-item d-flex align-items-center rounded-1">
									<input class="form-check-input m-0 me-2" type="checkbox">On Hold
								</label>
							</li>
							<li>
								<label class="dropdown-item d-flex align-items-center rounded-1">
				...
				<table class="table datatable quotations-table">
					...
					<tbody>
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-01.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Shaun Farley</a>
									</div>
								</div>
							</td>
							<td>
							...
							<td>
								<div class="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-end p-2">
										<li>
											<a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_inspection"><i class="ti ti-edit me-1"></i>Edit</a>
										</li>
										<li>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-12.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Jenny Ellis</a>
									</div>
								</div>
							</td>
							<td>
								<span class="badge badge-info-transparent d-inline-flex align-items-center badge-sm">
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-15.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Leon Baxter</a>
									</div>
								</div>
							</td>
							<td>
								<span class="badge badge-orange-transparent d-inline-flex align-items-center badge-sm">
									<i class="ti ti-point-filled me-1"></i>Need Repair
								</span>
							</td>
							<td>
								<div class="dropdown">
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-17.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Karen Flores</a>
									</div>
								</div>
							</td>
							<td>
								<span class="badge badge-purple-transparent d-inline-flex align-items-center badge-sm">
									<i class="ti ti-point-filled me-1"></i>Inprogress
								</span>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-06.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Michael Dawson</a>
									</div>
								</div>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-18.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Karen Galvan</a>
									</div>
								</div>
							</td>
							<td>
								<span class="badge badge-warning-transparent d-inline-flex align-items-center badge-sm">
									<i class="ti ti-point-filled me-1"></i>On Hold
								</span>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-03.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Thomas Ward</a>
									</div>
								</div>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-17.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Aliza Duncan</a>
									</div>
								</div>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-05.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">James Higham</a>
									</div>
								</div>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{URL::asset('admin_assets/img/profiles/avatar-08.jpg')}}" alt="" class="rounded-circle"></a>
									<div>
										<a href="javascript:void(0);" class="fw-semibold d-block">Jade Robinson</a>
									</div>
								</div>
							</td>
							<td>
