                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-lg bg-gray-100 me-2 flex-shrink-0">
                                                            <img src="{{URL::asset('admin_assets/img/icons/storage-icon-03.svg')}}" class="w-auto h-auto" alt="Img">
                                                        </span>
                                                        <h6 class="fw-medium fs-14">Local Storage</h6>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-lg bg-gray-100 me-2 flex-shrink-0">
                                                            <img src="{{URL::asset('admin_assets/img/icons/aws.svg')}}" class="w-auto h-auto" alt="Img">
                                                        </span>
                                                        <h6 class="fw-medium fs-14">AWS</h6>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <a href="javascript:void(0);" class="btn btn-icon btn-sm me-2" data-bs-toggle="modal" data-bs-target="#aws_settings"><i class="ti ti-settings fs-20"></i></a>
                                                        <div class="form-check form-check-md form-switch">
                                                            <input class="form-check-input me-2" type="checkbox" role="switch">
                                                        </div>
                                                    </div>													
