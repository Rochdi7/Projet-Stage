                            ...
                            <div class="payment-section">
                                <div class="border-bottom pb-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                        ...
                                        <div>
                                            <div>
                                                <a href="javascript:void(0);" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_tax_rate"><i class="ti ti-plus me-2"></i>Add New Tax Rate</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /Table Header -->
                                        ...
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-gray-9 fw-semibold fs-14">VAT</p>
                                                    </td>
                                                    <td>
                                                        <p class="text-gray-9">10%</p>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end p-2">
                                                                <li>
                                                                    <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_tax_rate"><i class="ti ti-edit me-1"></i>Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_tax_rate"><i class="ti ti-trash me-1"></i>Delete</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-gray-9 fw-semibold fs-14">CGST</p>
                                                    </td>
                                                    <td>
                                                        <p class="text-gray-9">08%</p>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-gray-9 fw-semibold fs-14">SGST</p>
                                                    </td>
                                                    <td>
                                                        <p class="text-gray-9">10%</p>
                                                    </td>
                                ...
                                <div class="pt-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                        ...
                                        <div>
                                            <div>
                                                <a href="javascript:void(0);" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_tax_group"><i class="ti ti-plus me-2"></i>Add New Tax Group</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /Table Header -->
                                        ...
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-gray-9 fw-semibold fs-14">GST</p>
                                                    </td>
                                                    <td>
                                                        <p class="text-gray-9">18%</p>
                                                    </td>
                                                    <td>
                                                        <p class="text-gray-9">20 Dec 2024</p>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            <button class="btn btn-icon btn-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end p-2">
                                                                <li>
                                                                    <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_tax_group"><i class="ti ti-edit me-1"></i>Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_tax_group"><i class="ti ti-trash me-1"></i>Delete</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
