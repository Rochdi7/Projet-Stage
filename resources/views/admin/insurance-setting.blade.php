                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-insurance"><i class="ti ti-plus me-1"></i>Add Insurance</a>
                                </div>
                            </div>
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium fs-14">Full Premium Insurance</h6>
                                            </td>
                                            <td>
                                                $200
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    4 Benefits
                                                    <a href="javascript:void(0);" class="btn btn-xs btn-info-light border-info fs-14 py-0 px-1 ms-1" data-bs-toggle="modal" data-bs-target="#view-benifits"><i class="ti ti-external-link"></i></a>
                                                </div>
                                            </td>
                                            <td><span class="badge badge-dark-transparent d-inline-flex align-items-center"><i class="ti ti-point-filled text-success me-1"></i>Active</span></td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end p-2">
                                                        <li>
                                                            <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit-insurance"><i class="ti ti-edit me-1"></i>Edit</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_backup"><i class="ti ti-trash me-1"></i>Delete</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium fs-14">Roadside Assistance </h6>
                                            </td>
                                            <td>
                                                $250
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium fs-14">Liability Insurance</h6>
                                            </td>
                                            <td>
                                                $150
                                            </td>
                                            ...
                                            <td><span class="badge badge-dark-transparent d-inline-flex align-items-center"><i class="ti ti-point-filled text-danger me-1"></i>Inctive</span></td>
                                            <td>
                                                <div class="dropdown">
                                                    <button class="btn btn-icon btn-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="ti ti-dots-vertical"></i>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium fs-14">Personal Accident Insurance	</h6>
                                            </td>
                                            <td>
                                                $300
                                            </td>
