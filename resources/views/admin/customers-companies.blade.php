        ...
        <div class="content me-4">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    ...
                    <div class="mb-2">
                        <a href="javascript:void(0);" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_company"><i class="ti ti-plus me-2"></i>Add New Company</a>
                    </div>
                </div>
            </div>
            <!-- /Breadcrumb -->
            ...
            <div class="d-flex align-items-center mb-4">
                <a href="{{url('admin/customers')}}" class="btn btn-white me-3"><i class="ti ti-user me-1"></i>Clients</a>
                <a href="{{url('admin/customers-companies')}}" class="btn bg-secondary-transparent"><i class="ti ti-building me-1"></i>Companies</a>
            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-1.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Elite Solutions</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end p-2">
                                        <li>
                                            <a class="dropdown-item rounded-1" href="{{url('admin/company-details')}}"><i class="ti ti-eye me-1"></i>View Details</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="dropdown-item rounded-1" href="{{url('admin/add-reservation')}}"><i class="ti ti-calendar me-1"></i>Book a Car</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-2.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Violet Photography</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-3.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Dynasty</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-4.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Flame Quill</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-5.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Quill Pen Finance</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-xxs rounded-circle me-1 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/flags/de-flag.svg')}}" class="rounded-circle" alt="img">
                                    </a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-6.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Heavenly Flow</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-7.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Butterfly Creative</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-8.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Sand Studios</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-9.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Colibri Solutions</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{url('admin/company-details')}}" class="avatar rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('admin_assets/img/companies/company-10.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <h6 class="fs-14 fw-semibold"><a href="{{url('admin/company-details')}}">Bishu Infotech</a></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
