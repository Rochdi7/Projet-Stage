...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content me-0 me-lg-4 pb-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="card">
                        ...
                        <form action="{{url('admin/seo-setup')}}">
                            <div class="card-body">
                                <h6 class="fw-bold mb-3">SEO Setup - Site Meta</h6>
                                <div class="mb-3">
                                ...
                                <h6 class="fw-bold mb-3">SEO Setup - OG Meta</h6>
                                <div class="mb-3">
