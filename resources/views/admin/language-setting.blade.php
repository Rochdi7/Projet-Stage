                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('admin/language-setting2')}}" class=" me-2"><img src="{{URL::asset('admin_assets/img/flags/usa.svg')}}" alt="img" class="avatar avatar-md rounded-circle"></a>
                                                    <a href="{{url('admin/language-setting2')}}" class="fw-semibold">English</a>
                                                </div>
                                            </td>
                                            <td>
                                                en
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('admin/language-setting2')}}" class="btn btn-white me-1">Web</a>
                                                    <a href="{{url('admin/language-setting2')}}" class="btn btn-white me-1">App</a>
                                                    <a href="{{url('admin/language-setting2')}}" class="btn btn-white">Admin</a>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('admin/language-setting2')}}" class=" me-2"><img src="{{URL::asset('admin_assets/img/flags/germany.svg')}}" alt="img" class="avatar avatar-md rounded-circle"></a>
                                                    <a href="{{url('admin/language-setting2')}}" class="fw-semibold">German</a>
                                                </div>
                                            </td>
                                            <td>
                                                de
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('admin/language-setting2')}}" class=" me-2"><img src="{{URL::asset('admin_assets/img/flags/uae.svg')}}" alt="img" class="avatar avatar-md rounded-circle"></a>
                                                    <a href="{{url('admin/language-setting2')}}" class="fw-semibold">Arabic</a>
                                                </div>
                                            </td>
                                            <td>
                                                ar
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('admin/language-setting2')}}" class=" me-2"><img src="{{URL::asset('admin_assets/img/flags/france.svg')}}" alt="img" class="avatar avatar-md rounded-circle"></a>
                                                    <a href="{{url('admin/language-setting2')}}" class="fw-semibold">French</a>
                                                </div>
                                            </td>
                                            <td>
                                                fr
