                    ...
                    <div class="card-body">
                        <div class="payment-section">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                    ...
                                    <div>
                                        <div>
                                            <a href="javascript:void(0);" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_currency"><i class="ti ti-plus me-2"></i>Add New Currency</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- /Table Header -->
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-gray-9 fw-semibold fs-14">Dhirams</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">AED</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">د.إ</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">3.67</p>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end p-2">
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_currencies"><i class="ti ti-edit me-1"></i>Edit</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_currencies"><i class="ti ti-trash me-1"></i>Delete</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-gray-9 fw-semibold fs-14">Rupee</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">INR</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">₹</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">86.62</p>
                                                </td>
                                                <td>
                                                    <span class="badge badge-outline d-inline-flex align-items-center badge-sm">
                                                        <i class="ti ti-point-filled me-1 text-success"></i>Active</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-gray-9 fw-semibold fs-14">Pound</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">GBP</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">£</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">0.81</p>
                                                </td>
                                                <td>
                                                    <span class="badge badge-outline d-inline-flex align-items-center badge-sm">
                                                        <i class="ti ti-point-filled me-1 text-success"></i>Active</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-gray-9 fw-semibold fs-14">Euro</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">EUR</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">€</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">0.96</p>
                                                </td>
                                                <td>
                                                    <span class="badge badge-outline d-inline-flex align-items-center badge-sm">
                                                        <i class="ti ti-point-filled me-1 text-success"></i>Active</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-gray-9 fw-semibold fs-14">Dollar</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">USD</p>
                                                </td>
                                                <td>
                                                    <p class="text-gray-9">$</p>
                                                </td>
