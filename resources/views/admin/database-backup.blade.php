                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#generate">Generate Backup</a>
                            </div>
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end p-2">
                                                        <li>
                                                            <a class="dropdown-item rounded-1" href="javascript:void(0);"><i class="ti ti-restore me-1"></i>Restore</a>
                                                        </li>
                                                        <li>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-semibold fs-14"><a href="javascript:void(0);">Full_Database_Backup_2024-10-11.sql</a></h6>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-semibold fs-14"><a href="javascript:void(0);">Full_Database_Backup_2024-09-11.sql</a></h6>
                                            </td>
                                            <td>
