        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('backoffice.vehicles.controls.update', [$vehicle->id, $control->id]) }}" 
                              method="POST" 
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="vehicle_id" 
                                            ...
                                            @foreach($vehicles as $v)
                                                <option value="{{ $v->id }}" 
                                                    {{ old('vehicle_id', $control->vehicle_id) == $v->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="agency_id" 
                                            ...
                                            @foreach($agencies as $agency)
                                                <option value="{{ $agency->id }}" {{ old('agency_id', $control->agency_id) == $agency->id ? 'selected' : '' }}>
                                                    {{ $agency->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               name="control_number"
                                               value="{{ old('control_number', $control->control_number) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="performed_by" 
                                            ...
                                            @foreach($users as $user)
                                                <option value="{{ $user->id }}" {{ old('performed_by', $control->performed_by) == $user->id ? 'selected' : '' }}>
                                                    {{ $user->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                   name="start_mileage"
                                                   value="{{ old('start_mileage', $control->start_mileage) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                   name="end_mileage"
                                                   value="{{ old('end_mileage', $control->end_mileage) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="notes"
                                                  ...
                                                  rows="4">{{ old('notes', $control->notes) }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                <a href="{{ route('backoffice.vehicles.controls.index', $vehicle->id) }}" class="btn btn-light px-4">
