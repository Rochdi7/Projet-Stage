    ...
    <div class="content me-0">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="mb-3">
                    <a href="{{ route('backoffice.vehicles.oil-changes.index', $vehicle->id ?? 1) }}" class="d-inline-flex align-items-center fw-medium">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('backoffice.vehicles.oil-changes.store') }}" 
                              method="POST" 
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                <a href="{{ route('backoffice.vehicles.oil-changes.index', $vehicle->id ?? 1) }}" class="btn btn-light px-4">
