...
<div class="modal fade" id="delete_oil_change" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content text-center p-3">
            ...
            <p class="mb-3">
                Êtes-vous sûr de vouloir supprimer la vidange
                <strong id="deleteOilChangeDetails">—</strong> ?
            </p>
            <form id="deleteOilChangeForm" method="POST">
                @csrf
                @method('DELETE')
