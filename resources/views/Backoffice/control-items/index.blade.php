        ...
        <form method="GET" id="filterForm" action="{{ request()->url() }}">
            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                <div class="d-flex align-items-center flex-wrap row-gap-3">
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end p-2">
                            <li>
                                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['sort' => 'key_asc']) }}">
                                    Clé A-Z
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['sort' => 'key_desc']) }}">
                                    Clé Z-A
                                </a>
                            </li>
                            <li>
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                    ...
                    <div class="mb-0">
                        <a href="{{ route('backoffice.vehicles.controls.items.create', [$vehicle->id, $control->id]) }}" class="btn btn-primary d-flex align-items-center">
                            <i class="ti ti-plus me-2"></i>Ajouter un élément
                        </a>
                    </div>
                    @endif
                </div>
