            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('backoffice.invoices.items.create', $invoice) }}" class="btn btn-sm btn-primary">
                    ...
                    <div class="card-body p-0">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end p-2">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('backoffice.invoices.items.show', [$invoice, $item]) }}">
                                                                <i class="ti ti-eye me-2"></i>Voir
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('backoffice.invoices.items.edit', [$invoice, $item]) }}">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item text-danger" 
                                                               ...
                                                               data-delete-action="{{ route('backoffice.invoices.items.destroy', [$invoice, $item]) }}"
                                                               data-delete-details="Ligne <strong>{{ $item->description }}</strong>">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <a href="{{ route('backoffice.invoices.items.create', $invoice) }}" class="btn btn-primary btn-sm">
                                    <i class="ti ti-plus me-1"></i>Ajouter une ligne
                                </a>
                            </div>
                        @endif
