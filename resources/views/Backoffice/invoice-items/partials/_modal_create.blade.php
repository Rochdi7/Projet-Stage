    ...
    <div class="content me-0">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="mb-3">
                    <a href="{{ route('backoffice.invoices.show', $invoice) }}" class="d-inline-flex align-items-center fw-medium">
                        <i class="ti ti-arrow-left me-1"></i> Retour à la facture
                    </a>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('backoffice.invoices.items.store', $invoice) }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <strong id="preview_ht">0,00 {{ $invoice->currency }}</strong>
                                                </div>
                                                <div class="col-md-4">
                                                    <small class="text-muted d-block">TVA</small>
                                                    <strong id="preview_vat">0,00 {{ $invoice->currency }}</strong>
                                                </div>
                                                <div class="col-md-4">
                                                    <small class="text-muted d-block">Total TTC</small>
                                                    <strong id="preview_ttc">0,00 {{ $invoice->currency }}</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                <a href="{{ route('backoffice.invoices.show', $invoice) }}" class="btn btn-light px-4">
                                    <i class="ti ti-x me-1"></i> Annuler
                                </a>
                                <button type="submit" class="btn btn-primary px-4">
                                    <i class="ti ti-device-floppy me-1"></i> Ajouter la ligne
                                </button>
                            </div>
                        </form>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
        ...
        const ttc = qty * price;
        const vatAmount = ttc * (vat / (100 + vat));
