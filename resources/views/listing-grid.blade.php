                                    ...
                                    <div class="img-slider owl-carousel">
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-01.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-01-slide1.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-01-slide2.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-01-slide3.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="listing-item">
                                <div class="listing-img">
                                    <div class="img-slider owl-carousel">
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-02.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-02-slide1.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-02-slide2.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-02-slide3.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="listing-item">
                                <div class="listing-img">
                                    <div class="img-slider owl-carousel">
                                        ...
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-07-slide1.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-07-slide2.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-07-slide3.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="listing-item">
                                <div class="listing-img">
                                    <div class="img-slider owl-carousel">
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-10.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-10-slide1.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-10-slide2.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-10-slide3.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="listing-item">
                                <div class="listing-img">
                                    <div class="img-slider owl-carousel">
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-08.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-08-slide1.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-08-slide2.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                        <div class="slide-images">
                                            <a href="{{url('listing-details')}}">
                                                <img src="{{ URL::asset('/build/img/cars/car-08-slide3.jpg') }}"
                                                    class="img-fluid" alt="Toyota">
                                            </a>
                                        </div>
                                    </div>
