<?php $page = 'booking-complete-calendar'; ?>
        ...
        <div class="container">
            ...
            <div class="content-header d-flex align-items-center justify-content-between">
                ...
                <ul class="booking-nav">
                    <li>
                        <a href="{{ url('user-booking-complete') }}"><i class="fa-solid fa-list"></i></a>
                    </li>
                    <li>
                        <a href="{{ url('booking-complete-calendar') }}" class="active"><i
